...
// Uploads from the Next.js server to MinIO.
// Notes:
// - Upload endpoint should be reachable from where this Next server runs.
// - The returned presigned URL should be reachable from the worker that ingests sources.
...
export async function handleSandboxUpload(request: NextRequest) {
